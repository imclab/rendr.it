    ...
    $.fn.split = function(options) {
        ...
        if (splitters.length == 0) { // first time bind events to document
            ...
            $(window).resize(function() {
                var i = 0;
                for (i; i < splitters.length; i++) {
                    splitters[i].trigger('splitter.resize');
                }
            });
        }
        splitters.push(self);
